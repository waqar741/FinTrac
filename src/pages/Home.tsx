...
const Home = () => {
    ...
    const dashboardImages = [
        { light: '/image/image.png', dark: '/image/dark.png', title: 'Main Dashboard' },
        { light: '/image/transaction-light.png', dark: '/image/transaction-dark.png', title: 'Transactions View' },
        { light: '/image/analytic-light.png', dark: '/image/analytic-dark.png', title: 'Analytics Dashboard' },
        { light: '/image/debt-light.png', dark: '/image/debt-dark.png', title: 'Debt & Credit Manager' }
    ];
                    ...
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-12 animate-fadeInUp">
                            ...
                            <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400 mb-8">
                                Choose between complete offline privacy or advanced online intelligence.
                            </p>
