...
//       description: "Get insights into your spending with beautiful charts and detailed reports."
//     },
//     {
//       icon: (
//         <svg className="w-6 h-6 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
//                 className="mx-auto rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 max-w-4xl w-full"
//               />
//             </div>
//           </div>
//         </section>
